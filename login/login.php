                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    ?>
                                    <form class="user" method="POST" action="loginQuery.php">
                                        ...
                                        <!-- <a href="../admin/index.php" class="btn btn-primary btn-user btn-block" name="btnLogin">
                                            Login
                                        </a> -->

                                        <input type="submit" name="btnLogin" class="btn btn-block btn-primary">
